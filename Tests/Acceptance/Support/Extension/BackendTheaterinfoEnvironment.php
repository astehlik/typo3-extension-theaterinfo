...
namespace Sto\Theaterinfo\Tests\Acceptance\Support\Extension;
...
class BackendTheaterinfoEnvironment extends BackendEnvironment
{
    public function __construct(array $config, array $options)
    {
        $this->localConfig = [
            'coreExtensionsToLoad' => AcceptanceHelper::getExtensionsForMinimalUsableSystem(),
            'testExtensionsToLoad' => ['typo3conf/ext/theaterinfo'],
    ...
    public function bootstrapTypo3Environment(SuiteEvent $suiteEvent): void
    {
        ...
        assert(defined('ORIGINAL_ROOT'), 'ORIGINAL_ROOT is not defined');
